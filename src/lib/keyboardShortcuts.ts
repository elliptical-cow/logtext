...
export const keyboardShortcuts: KeyboardShortcut[] = [
  ...
  { keys: "Cmd/Ctrl+Alt+L", description: "Show or hide the left pane" },
  { keys: "Cmd/Ctrl+Alt+M", description: "Show or hide the middle pane" },
  { keys: "Cmd/Ctrl+Alt+R", description: "Show or hide the right pane" },
